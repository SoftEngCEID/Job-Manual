...
public class Candid_list {
    ...
    //Μέθοδος για την εισαγωγή του candidate στο Candidate list αφού κάνει apply για κάποια θέση εργασίας (Δεν έχει υλοποιηθεί)
    public void Insert_Candidate(String Candid_User, String job, Map<String, Queue<String>> accepted){}

    //Μέθοδος για την Candidate List
    public void Get_Candidate_List(Map<String, Queue<String>> map, String job, Map<String, Queue<String>> accepted){
        ...
        user2.Insert_data("Arhodia", "Giannopoulou", "Odos 1", "30/06/2000", "Greek", "1234567890");
        ...
        System.out.println("Επιλέξτε τον υποψήφιο που επιθυμείτε:");
